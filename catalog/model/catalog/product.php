...
class ModelCatalogProduct extends Model {
	...
	public function getProductLayout($product_id){
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_to_layout as p2l " . 
				" left join ".DB_PREFIX."layout_route as lr on lr.layout_id = p2l.layout_id " .
				"WHERE product_id = '" . (int)$product_id . "' AND p2l.store_id = '" . (int)$this->config->get('config_store_id') . "' limit 1");
