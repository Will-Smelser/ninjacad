	...
	public function add() {
		...
		if ($product_info) {			
			...
			foreach ($product_options as $product_option) {
				...
				//test decimal
				if($product_option['type'] == 'decimal' && !empty($option[$product_option['product_option_id']])){
					if(strlen(preg_replace('/\-?[0-9]+\.?[0-9]+/','',$option[$product_option['product_option_id']])) > 0){
						$json['error']['option'][$product_option['product_option_id']] = 'Must be numberic!';
					}
				}
			}
